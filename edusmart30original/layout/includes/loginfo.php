...
<div class="not-login pull-right">
    <nav class="main-nav">
        <ul>
            ...
            <li><a class="cd-signin" href="#0"><img src="<?php echo $CFG->wwwroot ?>/theme/edusmart30/pix/images/login.png" alt="" />Sign in</a></li>
        </ul>
    </nav>
            ...
            <div id="cd-login"> <!-- log in form -->
                ...
                <form action="<?php echo $CFG->httpswwwroot; ?>/login/index.php" method="post" class="cd-form" <?php echo $autocomplete; ?> >
            	    ...
            	    <p class="fieldset">
            			...
            			<input type="text" class="username full-width has-padding has-border username" required="" name="username" id="signup-username" value="" placeholder="Username">
            			<span class="cd-error-message">Error message here!</span>
            		</p>
    
            		<p class="fieldset">
            		    <label class="image-replace cd-password" for="signin-password">Password</label>     		
                        <input type="password" class="password full-width has-padding has-border full-width has-padding has-border" required="" name="password" id="signup-password" placeholder="Password" value="">   		
                    ...
                    <?php 
                    if (!right_to_left()) { ?>
                        <button class="full-width" value="Login" onclick="checkuserdetail()">Log In</button>
                    <?php } else { ?>
                        <button class="full-width" value="Login">Log In</button>
                    <?php } ?>
